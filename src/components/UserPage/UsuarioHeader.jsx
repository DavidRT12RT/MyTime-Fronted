        ...
        <section className="userHeader">
            ...
            <div className="headerUser">

                {
                    ...
                    : 
                    <img className="headerUserImage" src={`${process.env.REACT_APP_BACKEND_API_URL}/api/usuarios/${userInfo.uid}/fotos/?tipo=header`}/>
                }
                ...
                <div className="imagePerfilUser">
                    {
                        ...
                        :
                        <img className="imagePerfilUserImage" src={`${process.env.REACT_APP_BACKEND_API_URL}/api/usuarios/${userInfo.uid}/fotos/?tipo=perfil`}/>
                    }
